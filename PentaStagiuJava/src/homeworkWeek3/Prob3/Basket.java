	  ...
	  double totalPrice;
	    ...
	    public void addCandyInBasket(Candy candy, int quantity) {
	        if (quantity <= candy.getQuantity()) {
	            totalPrice  = totalPrice + candy.getPrice() * quantity;
	            candy.setQuantity(candy.getQuantity() - quantity);
	            System.out.println("Total: " + totalPrice);
	        } else
	            System.out.println("Sorry not in Stock, have only : " + candy.getQuantity());
	    }
	    ...
	    public void cashOut() {
	        if (customer.getMembership() == Customer.membership.Gold) {
	            ...
	            System.out.println("The price to pay: " + totalPrice * 0.9);
	            System.out.println("You saved: " + totalPrice * 0.10);
	        } else
	            System.out.println("The price to pay: " + totalPrice);
	        totalPrice = 0;
	    }

	    public void totalPricePrinter() {
	        if (customer.getMembership() == Customer.membership.Gold) {
	            System.out.println("The price to pay: " + totalPrice * 0.8);
	        } else if (customer.getMembership() == Customer.membership.Silver) {
	            System.out.println("The price to pay: " + totalPrice * 0.9);
	        } else
	            System.out.println("The price to pay: " + totalPrice);
